...
Once the `conda-forge` channel has been enabled, `r-sparkr` can be installed with:

```
conda install r-sparkr
```

It is possible to list all of the versions of `r-sparkr` available on your platform with:
